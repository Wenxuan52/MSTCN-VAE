...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../../autodl-tmp/iMiGUE/')
    parser.add_argument('--out_folder', default='../data/iMiGUE/imigue_polarcoordinate_processed/')
    ...
    for p in part:
        ...
        if p == 'train':
            ...
            data_path = arg.data_path + 'imigue_skeleton_validate2'
        else:
             print('error')
